...
ibmcloud fn action create slackdemo/db2Setup db2-setup.js  --kind nodejs:16
...
ibmcloud fn action create slackdemo/dispatch dispatch.js  --kind nodejs:16 --web true --web-secure $theSecret
